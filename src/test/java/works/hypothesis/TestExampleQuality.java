...
public class TestExampleQuality {
	...
	public void testLexicographicBytes() throws NoSuchExample {
		final byte[] data = Hypothesis.find(new BytesStrategy(1000), new HypothesisPredicate<byte[]>() {
	...
	public void testSummingIntegers() throws NoSuchExample {
		...
		final List<Integer> result = Hypothesis.find(Strategies.lists(Strategies.integers()),
    ...
    public void testNonAssociativeFloats() throws NoSuchExample {
        ...
        final List<Float> result = Hypothesis.find(Strategies.lists(new FloatRangeGenerator(0, 1)),
